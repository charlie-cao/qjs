...
<body ontouchstart>
    ...
    <div class="weui-header bg-green">
        <div class="weui-header-left">
            <a href="pt_my_question_list.php" class="icon icon-85 f-white" style="font-size: 26px;"></a>
        </div>
        ...
        <div class="weui-flex">
            ...
            <div class="weui-flex-item">
                <div class="weui_tab_nav">
                    <a href="pt_main.php?tag=0" class="weui_navbar_item weui_nav_green <?=($_GET['tag']==0)?"bg_green":""?>"> 最值 </a>
                    <a href="pt_main.php?tag=1" class="weui_navbar_item weui_nav_green <?=($_GET['tag']==1)?"bg_green":""?>"> 最新 </a>
                </div>
            </div>
