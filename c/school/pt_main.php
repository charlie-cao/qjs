...
<div class="page-hd" style="padding: 0px">
    <div class="weui_tab" id="tab5" style="height:44px;">
        <div class="weui_navbar">
            <?php ?>
            <a href="pt_main.php?tag=0" class="weui_navbar_item <?php echo ($_GET['tag']==0)?"tab-green":"" ?>"> 动态 </a>
            <a href="school_3_2.php?tag=1" class="weui_navbar_item <?php echo ($_GET['tag']==1)?"tab-green":"" ?>"> 通知 </a>
            <a href="school_3_2.php?tag=2" class="weui_navbar_item <?php echo ($_GET['tag']==2)?"tab-green":"" ?>"> 校园 </a>
            <a href="school_3_2.php?tag=3" class="weui_navbar_item <?php echo ($_GET['tag']==3)?"tab-green":"" ?>"> 餐谱 </a>
            <a href="school_3_2.php?tag=4" class="weui_navbar_item <?php echo ($_GET['tag']==4)?"tab-green":"" ?>"> 校车 </a>
            <a href="school_3_2.php?tag=5" class="weui_navbar_item <?php echo ($_GET['tag']==5)?"tab-green":"" ?>"> 报名 </a>
        </div>
    </div>
</div>
