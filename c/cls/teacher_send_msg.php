...
//                        $(res.localIds).each(function (i,e) {
//                            $('#preview').append('<img class="weui_uploader_file p_img" src="'+e+'" ></img>'+i);
//                        })
...
//                $('#preview').append('<img class="weui_uploader_file p_img" src="'+localId+'" ></img>');
//                //异步发送图片，防止序列错误
