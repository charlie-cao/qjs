...
<div class="weui-header bg-green">
    <div class="weui-header-left">
        <a href="teacher_menu.php" class="title_icon" >
...
<div class="page-hd" style="padding: 0px">
    <div class="weui_tab" style="height:44px;">
        <div class="weui_navbar" style="">
            ...
            <a href="teacher_main.php?cls_id=<?= $_SESSION['cls_id'] ?>" class="weui_navbar_item <?php echo ($_GET['tag'] == "") ? " tab-green" : "" ?>">
                全部 </a>
            <?php foreach ($_SESSION['cls_tags'] as $key => $val) { ?>
                <a href="teacher_main.php?cls_id=<?= $_SESSION['cls_id'] ?>&tag=<?= $val['id'] ?>"
