...
<div class="page-hd" style="padding: 0px">
    <div class="weui_tab" style="height:44px;">
        <div class="weui_navbar" style="">
             <a href="teacher_main.php?tag=0" style="padding: 10px 0;" class="weui_navbar_item <?= ($_GET['tag']==0)?"tab-green":"" ?>"> 动态 </a>
             <a href="teacher_main.php?tag=1" style="padding: 10px 0;"  class="weui_navbar_item <?= ($_GET['tag']==1)?"tab-green":"" ?>"> 通知 </a>
             <a href="teacher_main.php?tag=2" style="padding: 10px 0;"  class="weui_navbar_item <?= ($_GET['tag']==2)?"tab-green":"" ?>"> 成长秀 </a>
        </div>
    </div>
</div>
