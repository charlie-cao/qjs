...
<div class="weui_tab tab-bottom">
    <div class="weui_tab_bd">
        ...
        <div class="weui-header bg-green">
            ...
            <h1 class="weui-header-title">我的班级</h1>
            <div class="weui-header-right"><a href="teacher_add_cls.php" class="icon icon-36 f-white"> 创建班级</a></div>
        </div>
                ...
                <div class="weui_cell">
                    ...
                    <div class="weui_cell_ft">
                        ...
                        <?php if ($val['is_cls_teacher'] == 1) { ?>
                            <a href="javascript:;" onclick="cannot_exit(1)"
                               class="weui_btn weui_btn_mini weui_btn_default">退出</a>
                        <?php } else if ($val['cls_id'] == $_SESSION['cls_id']) { ?>
                            <a href="javascript:;" onclick="cannot_exit(2)"
                               class="weui_btn weui_btn_mini weui_btn_default">退出</a>
                        <?php } else { ?>
